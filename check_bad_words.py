...
while check_word!= '#':
    if check_word[0] == '?':
        ...
        if check_word[-1] == '+':
            if check_word[0] == '!':
                check_word = '!/'+check_word[1:-1]+'(?:.{0,10}?)(?=(?:[^a-zA-Z0-9]*[a-zA-Z0-9]){3})(?=.*\d)[a-zA-Z0-9]{3,}/'
            else:
                check_word = '/'+check_word[:-1]+'(?:.{0,10}?)(?=(?:[^a-zA-Z0-9]*[a-zA-Z0-9]){3})(?=.*\d)[a-zA-Z0-9]{3,}/'
        # /something(?:.{0,10}?)[a-zA-Z0-9]{3,}/
        # /something(?:[^\n]{0,10}?)[a-zA-Z0-9]{3,}/
        # /something(?:.{0,10}?)(?=(?:[^a-zA-Z0-9]*[a-zA-Z0-9]){3})(?=.*\d)[a-zA-Z0-9]{3,}/
